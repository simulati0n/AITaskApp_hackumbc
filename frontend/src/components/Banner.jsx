    ...
    return (
        <>
            ...
            <div className="text-center  justpx-4 py-6 sm:px-0">
                ...
                <Button className="w-30 h-10 bg-blue-500 text-white hover:bg-blue-600">Get Started</Button>
                <Button variant="outline" className="w-30 h-10 bg-white text-blue-500 hover:bg-blue-100">Learn More</Button>
                </div>
                </div>
            </main>
            </div>
